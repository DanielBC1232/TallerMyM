  ...
  return (
    <div className="container mt-5 p-3">
      <div className="row gap-5 justify-content-center">
        ...
        <div className="col-sm-3 align-self-center">
          <Link to="/cotizacion" className="btn-link text-decoration-none">
            <Card width={300} direction="row" className="p-2">
              <Card.Header><SiMinutemailer size={55} color="#005ba5" className="d-flex align-self-baseline" /></Card.Header>
              <Card.Body as="h4" className="d-flex align-self-baseline">Cotizacion Cliente</Card.Body>
            </Card>
          </Link>
        </div>
