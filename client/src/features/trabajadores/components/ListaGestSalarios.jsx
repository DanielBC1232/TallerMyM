...
const ListaGestSalarios = ({formData, trigger}) => {
                        ...
                        <tr key={index}>
                            ...
                            <td>
                                ...
                                <button className="btn btn-secondary btn-sm text-white">
                                    <Link to={`/trabajadores-editar-salario/${trabajador.idTrabajador}`} className="btn-link">Editar Salario</Link>
...
export default ListaGestSalarios;
